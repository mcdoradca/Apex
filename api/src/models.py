...
class PriceHistoryDaily(Base):
    ...
    ticker = Column(VARCHAR(10), ForeignKey('companies.ticker', ondelete='CASCADE'), primary_key=True)
...
class SentimentAnalysis(Base):
    ...
    ticker = Column(VARCHAR(10), ForeignKey('companies.ticker', ondelete='CASCADE'))
