...
def _run_momentum_agent(ticker: str, api_client: object) -> dict:
    ...
    score = 0
    max_score = 4
    # ZMIANA: Z 'report_items = []' na 'details = {}'
    details = {}
...
def run_ai_analysis(ticker: str, api_client: object) -> dict:
    ...
    # ZMIANA: Tworzymy listę do obliczeń
    ...
    # ZMIANA: Zwracana struktura jest teraz zgodna z frontendem
    return {
        "status": "DONE",
        "ticker": ticker,
        "overall_score": total_score,                 # ZMIANA: Z "X/Y" na liczbę
        "max_score": total_max_score,                 # ZMIANA: Dodane pole
        "final_score_percent": round(final_score_percent),
        "recommendation": recommendation,
        "recommendation_details": recommendation_details,
        "agents": {                                   # ZMIANA: Z listy na obiekt
